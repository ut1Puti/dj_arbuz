...
public final class BotTextResponse {
    ...
    /**
     * Поле стартового сообщения бота
     */
    public static final String START = "Привет, я бот помогающий взаимодействовать с музыкальной индустрией. " +
            "Чтоб получить больше информации используйте /help";
    /**
    ...
    public static final String HELP_INFO = """
            ...
            Вы можете авторизоваться как админ группы использую команды /auth_as_admin.
            Так вы получите возможность отправлять сообщения подписчикам группы использующие этого бота.
            Для этого используйте команду "/post_to_group + screen name группы + текст который необходимо отправить"
            ...
            Чтобы подписаться на исполнителя используйте команду
            "/subscribe имя артиста или его псевдоним"
            Также можно получить все свои текущие подписки использовав команду
            "/subscribed"
